...
<body>
<div class="modal fade" id="addparts" tabindex="-1" role="dialog" aria-labelledby="exml" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exml">Add Parts</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form action="code.php" method="POST" id="addparts">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="name" class="form-control" placeholder="Enter part name">
                                </div>
                                <div class="form-group">
                                    <label for="imga">Parts image</label>
                                    <input type="text" name="image" class="form-control" id="imga"
                                        placeholder="Enter the image name with type">
                                </div>
                                <div class="form-group">
                                    <label>Price</label>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addpart">
                Add New Part
            </button>
            <div class="card shadow" style="margin-top:100px;">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Parts Details
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addparts">
                            Add New Parts
                        </button>
                    </h6>
                </div>
                        ...
                        <table class="table table-bordered mt-5" id="datatable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="manage/part_edit.php" method="POST">
