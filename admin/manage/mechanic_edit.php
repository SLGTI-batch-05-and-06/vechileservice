        ...
        <div class="main">
            ...
            <div class="card shadow" style="margin-top:30px; margin-bottom:100px;">
                <div class="card-header py-3">
                    <h6 class="mt-5 font-weight-bold text-primary">Edit Mechanic Details</h6>
                </div>
                <div class="card-body">
                    <?php 
                    if(isset($_POST['editbtn']))
                    {
                        ...
                        $query = "SELECT * FROM mechanic WHERE mechanic_id='$id' ";
                    ...
                    <form action="../code2.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="imga">Contact</label>
                            <input type="text" name="edit_phoneno" value="<?php echo $row['contact']?>"
