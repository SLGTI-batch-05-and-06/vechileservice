...
<body>
    <div class="modal fade" id="addservice" tabindex="-1" role="dialog" aria-labelledby="exml" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exml">Add Services</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="code3.php" method="POST" id="addservice">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Service</label>
                            <input type="text" name="service" class="form-control" placeholder="Enter the service">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="add3" class="btn btn-primary">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <table class="table table-bordered mt-5" id="datatable" width="100%" cellspacing="0">
                                ...
                                if(mysqli_num_rows($query_run) > 0)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="manage/service_edit.php" method="POST">
